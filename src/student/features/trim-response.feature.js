...
function requireStage3Capability(capabilities) {
  if (!capabilities?.[REQUIRED_CAPABILITY_ID]) {
    throw new TypeError(
      "Stage 3 component-sum capability is required."
    );
  }
}
  ...
  return [
...

    {
      ...
      passed:
        ...
        behavioralChanged.disturbanceTendency ===
          "restoring" &&
        closeTo(
